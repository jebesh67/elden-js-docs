      ...
      <CopyablePre theme={theme}>
        ...
        >
          <code>
            ...
            {"}"} from <span className="css-keyword-red">{`"elden-js"`}</span>;
            <br />
            <br />
            ...
            <span className="css-keyword-blue">verifyAccess</span>(
            <span className="css-keyword-red">{`"http://yourBackend"`}</span>,{" "}
            <span className="css-keyword-red">{`"tokenName"`}</span>,{" "}
            ...
            <br />{" "}
            <span className="css-comment">{`// redirect or deny access`}</span>
            <br />
            {"}"}
          </code>
        </pre>
